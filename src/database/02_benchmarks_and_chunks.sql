 -- 1: Check Metadata & Number of Chunks Created
  ...
  SELECT hypertable_name,pg_size_pretty(hypertable_size(hypertable_name::regclass)) as total_size FROM timescaledb_information.hypertables;

  -- Test 3: Compare Query Execution Speed 
